...
test_html = Test.create!( title: 'HTML', level: 1, category_id: category_web.id, author_id: user1.id )
test_python = Test.create!( title: 'Python', level: 2, category_id: category_ml.id, author_id: user2.id )
test_ruby = Test.create!( title: 'Ruby', level: 1, category_id: category_rf.id, author_id: user1.id  )
test_rails = Test.create!( title: 'Rails', level: 2, category_id: category_rf.id, author_id: user1.id  )
