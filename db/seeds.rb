...
users = User.create!( [{ password: '123', email: 'a@a.com', access_admin: false}, { password: '456', email: 'b@a.com', access_admin: false}, { password: 'admin', email: 'c@a.com', access_admin: true }] )
