...
users = User.create!( [{name: 'User1', password: '123', email: 'a@a.com', access_admin: false}, {name: 'User2', password: '456', email: 'b@a.com', access_admin: false}, {name: 'Admin', password: 'admin', email: 'c@a.com', access_admin: true }] )
